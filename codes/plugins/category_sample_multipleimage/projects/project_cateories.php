<?php
if (!class_exists("ProjectCategories")) {
	require_once('classes/project_categories.class.php');
	class ProjectCategories {
		...
		function __construct() {
			...
			//Set Table Name
			$this->table_name = $wpdb->prefix."project_categories";
			
			//Set Base URL
			$this->base_url = 'admin.php?page=project_categories';
		...
		function display(){
			...
			<div class="wrap">
				<?php
					...
					$Project_Categories_Table = new Project_Categories_Table();
					$Project_Categories_Table -> prepare_items($_GET['s']);
					
					?>
					<!-- Forms are NOT created automatically, so you need to wrap the table in one to use features like bulk actions -->
			        <form id="project_categories" method="get">
			        	<?php $Project_Categories_Table -> search_box( 'Search Title', 'title_search' ); ?>
			            <!-- For plugins, we also need to ensure that the form posts back to our current page -->
			            <input type="hidden" name="page" value="<?php echo $_REQUEST['page'] ?>" />
			            <!-- Now we can render the completed list table -->
			            <?php $Project_Categories_Table -> display(); ?>
			        </form>
			</div>
			<?php
		}		
		...
		function add(){
			...
			$submit_btn_text = 'Add Project Category';
		...
		function edit(){
			...
			$submit_btn_text = 'Save Project Category';
		...
		function save(){
            ...
            wp_redirect(site_url('/wp-admin/admin.php?page=project_categories'));
		}
