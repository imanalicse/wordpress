...
<div class="wrap">
  ...
  <form id="project_edit_form" name="project_edit_form" method="post" action="<?php echo $this->base_url; ?>&projectId=<?php echo $this->projectId; ?>" enctype="multipart/form-data">
    ...
    <p class="submit">
      ...
      <input type="hidden" value="<?php echo $this->projectId; ?>" name="wa_data[project_id]" />
