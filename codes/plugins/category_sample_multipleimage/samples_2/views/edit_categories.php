<div class="wrap">
  ...
  <form id="sample_category_edit_form" name="sample_category_edit_form" method="post" action="<?php echo $this->base_url; ?>" enctype="multipart/form-data">  
    ...
    <p class="submit">
      ...
      <input type="hidden" value="<?php echo $row->ID; ?>" name="wa_data[id]" id="sample_category_id">
    </p>
...
<script language="JavaScript">
    jQuery(document).ready(function() {
        ...
        // START: slug generate
        jQuery('#sample_category_edit_form #title').keyup(function() {
            var str = this.value;
            jQuery.ajax({
                type: 'POST',
                url: ajaxurl,
                ...
                success: function(response){
                    jQuery('#sample_category_edit_form #slug').val(response);
                }
            });
        });
        // END: slug generate
        ...
        // START: slug checking
        jQuery('#sample_category_edit_form').submit(function(ev) {
            var slug = jQuery(this).find('#slug').val();
            var sample_category_id = jQuery(this).find('#sample_category_id').val();
            jQuery.ajax({
                type: 'POST',
                url: ajaxurl,
                data: {
