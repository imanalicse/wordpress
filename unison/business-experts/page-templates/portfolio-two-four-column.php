<?php
/*
 * Template Name: portfolio-two-four-column
 * */
get_header();
global $post;
$postID = $post->ID;
         ...
         <div class="container-fluid">
            ...
            <div class="filterContent" id="sm_load_div">
               ...
               while ($folio->have_posts())
               {
                  ...
                  ?>
                  <div class="col-lg-3 col-sm-6 col-xs-12 mix <?php echo esc_attr($cats); ?>">
            ...
            if (function_exists('sm_load_more_pagination'))
            {
               ...
               echo sm_load_more_pagination($argument,$folio->max_num_pages, $paged+1, ' col-lg-3 col-sm-6 col-xs-12');
            }
            ?>
         </div>
      </div>
