<div class="wrap">
  ...
  <form id="video-edit-form" name="video-edit-form" method="post" action="<?php echo $this->base_url; ?>" enctype="multipart/form-data">
    ...
    <table class="form-table">
      <tbody>
        ...
        <tr class="form-field">
            <th scope="row"><label>Video Link</label></th>
            <td><input type="text" name="wa_data[video_link]" value="<?php echo $row->video_link; ?>" /></td>
        </tr>
        ...
        <tr class="form-field">
            ...
            <td><input type="text" class="small-text" name="wa_data[ordering]" value="<?php echo $row->ordering; ?>" /></td>
        </tr>
